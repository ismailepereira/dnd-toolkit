...
const AVENTURAS_PRONTAS = [
  ...
  {
    id: 'modelo_ninho_ep7_refugio',
    titulo: 'Ninho da Rainha Dragão — Ep. 7: O Refúgio de Caça',
    limites: { jogadoresMax: 5, nivelMin: 6, nivelMax: 7 },
    noInicial: 'e7_chegada',
    nos: [
      // ====== EPISÓDIO 7 — O REFÚGIO DE CAÇA ======
      // Adaptação própria e condensada (Ep7 do docs/CAMPANHA-NINHO.md).
      // Onde o tesouro é embarcado no castelo voador. Talis, a Branca, é a
      // dissidente: o episódio se resolve por infiltração OU por aliança.
      {
        id: 'e7_chegada', titulo: 'Neve e troféus', tipo: 'social',
        narracao: 'Do outro lado das runas o mundo é branco: um refúgio de caça de madeira escura encravado numa encosta gelada, cercado de pinheiros e de neve pisada por botas demais. Cabeças de feras encaram das paredes. E lá fora, pairando impossível sobre o vale como uma montanha que esqueceu de cair, uma sombra colossal de pedra e gelo — um castelo. Voando.',
        notasMestre: 'Abertura do Ep7. Se vieram pelo círculo (Ep6), caem DENTRO do salão, junto às arcas; se vieram pelo caminho longo, chegam pela neve e podem reconhecer de fora. Estabeleça a imagem: o castelo voador é o destino final do tesouro, e ele parte em dias. Regra do episódio: o refúgio é guarnecido demais para um assalto frontal — a saída é infiltrar ou ALIAR-SE a Talis. Frio: sem proteção, considere Constituição CD 10/hora nas cenas externas.',
        encontro: [], saidas: [
          { para: 'e7_hub', rotulo: 'Reconhecer o refúgio', aviso: '' },
        ],
      },
      {
        id: 'e7_hub', titulo: 'Dentro do refúgio', tipo: 'social',
        narracao: 'O refúgio é grande e mal-usado: um salão de troféus onde as arcas se empilham à espera de embarque, corredores de quartos frios, um pátio de neve batida onde os dracos são exercitados, e uma escada que sobe para a ala que ninguém visita sem ser chamado. Do pátio, correntes grossas sobem para o castelo lá em cima — é por elas que a carga sobe.',
        notasMestre: 'HUB do episódio. As saídas se cruzam: o salão dos troféus (as arcas, o embarque), o pátio (os dracos e as correntes = a rota física para o castelo), os quartos (fofoca e a pista sobre Talis), a ala de cima (Talis em pessoa). O objetivo é SUBIR ao castelo — a bordo da carga, pelas correntes, ou convidado por Talis. Ela é a chave: rancorosa com Rezmir por ter sido preterida, e disposta a negociar.',
        encontro: [], saidas: [
          { para: 'e7_troféus', rotulo: 'Salão dos troféus (as arcas)', aviso: '' },
          { para: 'e7_patio', rotulo: 'Pátio (os dracos e as correntes)', aviso: 'mortal' },
          { para: 'e7_quartos', rotulo: 'Corredor dos quartos (ouvir)', aviso: '' },
          { para: 'e7_bosque', rotulo: 'Rodear pelo bosque gelado', aviso: '' },
          { para: 'e7_talis', rotulo: 'Subir à ala de cima (Talis)', aviso: 'mortal' },
          { para: 'e7_partir', rotulo: 'Deixar o castelo partir sem vocês', aviso: 'beco' },
        ],
      },
      {
        id: 'e7_troféus', titulo: 'O salão dos troféus', tipo: 'assalto',
        narracao: 'Sob as cabeças empalhadas, o saque de meia dúzia de vilas espera a vez de subir: arcas lacradas, fardos, uma fila de cultistas conferindo róis. Cada carga é içada por uma rede que sobe pelas correntes e some na barriga do castelo. Uma arca vazia, aberta e esquecida num canto, é do tamanho de uma pessoa encolhida.',
        notasMestre: 'A ROTA MAIS ELEGANTE para o castelo: subir DENTRO da carga. Furtividade CD 14 para entrar numa arca/rede sem ser visto (ou Enganação CD 13 com disfarce para se passar por carregador e subir junto). Sucesso = chegam ao Ep8 escondidos, no coração do castelo. Falha = alarme. Aqui também dá para sabotar (atrasar o embarque) ou marcar uma arca para achar o tesouro depois.',
        encontro: [], saidas: [
          { para: 'e7_hub', rotulo: 'Recuar e pensar melhor', aviso: '' },
          { para: 'e7_final_carga', rotulo: 'Subir escondido na carga', aviso: '' },
          { para: 'e7_alarme', rotulo: 'Fomos vistos entre as arcas', aviso: 'mortal' },
        ],
      },
      {
        id: 'e7_patio', titulo: 'O pátio dos dracos', tipo: 'encontro',
        narracao: 'No pátio de neve batida, tratadores exercitam répteis de coleira que fumegam ao respirar. Das argolas de ferro cravadas na rocha sobem correntes grossas como o braço de um homem, subindo, subindo, até se perderem na base do castelo. Dá para escalar. Dá também para cair de muito alto.',
        notasMestre: 'A rota FÍSICA: escalar as correntes (Atletismo CD 15; falha = queda, e a esta altura isso mata — daí o aviso 💀). Melhor à noite e depois de resolver os dracos (encontro abaixo) ou distraí-los (carne, Adestrar Animais CD 14). É a rota mais arriscada e a mais livre: chegam ao castelo sem dever favor a ninguém. Barulho aqui acorda o refúgio.',
        encontro: [{ nome: 'Guarda Draco (Guard Drake)', qtd: 3 }, { nome: 'Cultista', qtd: 2 }],
        saidas: [
          { para: 'e7_hub', rotulo: 'Voltar para dentro', aviso: '' },
          { para: 'e7_final_correntes', rotulo: 'Escalar as correntes até o castelo', aviso: 'mortal' },
        ],
      },
      {
        id: 'e7_quartos', titulo: 'O corredor dos quartos', tipo: 'social',
        npcs: [
          { nome: 'Yarra', tipo: 'neutro', descricao: 'Cozinheira do refúgio, velha e surda de um ouvido, que serve todo mundo e por isso ouve todo mundo; não é do culto — trabalha ali porque pagam.', notasPrivadas: 'NÃO é cultista, só empregada. Com gentileza (ou moedas) conta o essencial: "a senhora de branco" (Talis) e "a de escamas negras" (Rezmir) brigaram feio; Rezmir levou a máscara e o comando, Talis ficou com o refúgio e a raiva. O castelo parte em poucos dias. Se maltratada, grita.' },
        ],
        narracao: 'Os quartos são frios e a maioria está vazia — o grosso do culto já subiu. Numa cozinha nos fundos, uma velha remexe um caldeirão sem levantar os olhos e fala sozinha, ou talvez para vocês: "Todo mundo aqui anda pisando em ovos desde a briga das duas. A de preto levou tudo. A de branco ficou com a casa. E nenhuma das duas é gente boa."',
        notasMestre: 'Cena de informação — a MELHOR preparação para Talis. Yarra entrega o conflito: Rezmir foi promovida (levou a Máscara Negra e o comando do castelo), Talis foi deixada para trás com o refúgio, e o ressentimento é enorme. Saber disso dá VANTAGEM na negociação com Talis (e o Mestre pode conceder isso mecanicamente: Persuasão com vantagem no nó dela).',
        encontro: [], saidas: [
          { para: 'e7_hub', rotulo: 'Voltar a circular', aviso: '' },
          { para: 'e7_talis', rotulo: 'Subir para falar com Talis, sabendo do rancor', aviso: '' },
        ],
      },
      {
        id: 'e7_bosque', titulo: 'O bosque gelado', tipo: 'encontro',
        narracao: 'Fora do círculo de luz do refúgio, o bosque é silêncio e neve até os joelhos. Aqui os cultistas caçam para abastecer a despensa — e aqui, longe de olhos e de sinos de alarme, dá para pegar um deles sozinho. Pegadas frescas contam que uma patrulha passou há pouco. Outras pegadas, muito maiores, contam outra coisa.',
        notasMestre: 'Cena externa: o jeito mais seguro de conseguir um DISFARCE (as vestes de um cultista caçador), um prisioneiro para interrogar ou simplesmente contornar o refúgio até o pátio. Encontro: uma patrulha de caça (abaixo) — longe do refúgio, ninguém ouve. FRIO: Constituição CD 10 por hora sem proteção. As pegadas grandes são um urso-coruja da encosta — use se quiser tensão extra, ou deixe como presságio. Interrogar um caçador confirma: o castelo parte em dias, e "a senhora branca" não sobe com ele.',
        encontro: [{ nome: 'Cultista', qtd: 3 }, { nome: 'Draco de Emboscada (Ambush Drake)', qtd: 2 }],
        saidas: [
          { para: 'e7_hub', rotulo: 'Voltar ao refúgio com o que conseguiram', aviso: '' },
          { para: 'e7_patio', rotulo: 'Contornar direto para o pátio das correntes', aviso: '' },
        ],
      },
      {
        id: 'e7_talis', titulo: 'Talis, a Branca', tipo: 'social',
        npcs: [
          { nome: 'Talis, a Branca', tipo: 'inimigo', descricao: 'Meia-dragã de escamas brancas e olhos frios, senhora do refúgio; recebe vocês sentada, sem sacar arma, como quem já pesou a utilidade de cada um.', notasPrivadas: 'Bloco: Talis, a Branca (Meia-Dragã) — no bestiário. É a DISSIDENTE: preterida por Rezmir, quer vê-la cair sem sujar as próprias mãos. NEGOCIÁVEL: se os PJs oferecerem a queda de Rezmir, ela dá passagem para o castelo (a rota mais segura) e informação (a planta, o dragão acorrentado, onde Rezmir dorme). Preço: que Rezmir caia, e que o crédito não seja dela. NÃO é aliada de verdade — é uma inimiga com um inimigo em comum. Se atacada ou desprezada, luta (sopro de frio).' },
        ],
        narracao: 'A ala de cima é quente e silenciosa. Numa poltrona diante da lareira, uma meia-dragã de escamas brancas gira uma taça sem beber e não se dá ao trabalho de se levantar. "Sentem-se", diz Talis, sem surpresa nenhuma. "Vocês perseguiram um tesouro pelo continente inteiro e chegaram até a minha porta. Eu não vou chamar a guarda. Estou curiosa: o que é que vocês querem com a Rezmir?"',
        notasMestre: 'O nó mais importante do episódio, e é CONVERSA, não luta. Talis foi preterida e ferve de rancor. Ofereçam a queda de Rezmir e ela abre o caminho: passagem segura ao castelo, a planta do lugar, onde Rezmir guarda a Máscara e a existência do dragão branco acorrentado. Com a fofoca de Yarra, a Persuasão tem VANTAGEM (CD 13; sem a fofoca, CD 16). Ela nunca luta ao lado dos PJs — só abre a porta e assiste. Desprezá-la/atacá-la = combate duro (sopro de frio) e a porta fechada.',
        encontro: [], saidas: [
          { para: 'e7_final_talis', rotulo: 'Fechar o acordo com Talis', aviso: '' },
          { para: 'e7_luta_talis', rotulo: 'Recusar/atacar a senhora do refúgio', aviso: 'mortal' },
        ],
      },
      {
        id: 'e7_luta_talis', titulo: 'O sopro branco', tipo: 'encontro',
        narracao: 'A taça se parte na lareira e o ar do salão cai vinte graus num instante. "Que pena", diz Talis, e o frio já está saindo por entre os dentes dela. Da escada sobem passos: a guarda do refúgio ouviu.',
        notasMestre: 'Combate contra Talis (CR 4) + guarda (abaixo). Duro mas vencível no nível 6-7. Ela luta com o cone de frio e a rapieira, e recua para a janela se cair a ~1/4 dos PV (some na neve, vira gancho). Vencer aqui: pegam a chave do refúgio e a rota fica livre — mas perdem a informação e o aliado-conveniente que ela seria. Custo real, não punição.',
        encontro: [{ nome: 'Talis, a Branca (Meia-Dragã)', qtd: 1 }, { nome: 'Fanático do Culto (Cult Fanatic)', qtd: 1 }, { nome: 'Cultista', qtd: 3 }],
        saidas: [
          { para: 'e7_final_correntes', rotulo: 'Tomar o refúgio e escalar as correntes', aviso: '' },
          { para: 'e7_alarme', rotulo: 'O refúgio inteiro cai em cima', aviso: 'mortal' },
        ],
      },
      {
        id: 'e7_alarme', titulo: 'O refúgio desperta', tipo: 'encontro',
        narracao: 'Um chifre de caça soa no salão e o refúgio inteiro se fecha: cultistas nos corredores, dracos soltos no pátio, e lá em cima as correntes começam a ser recolhidas. O castelo está se preparando para partir — com ou sem vocês.',
        notasMestre: 'Cena de PRESSÃO, não de vitória. O relógio: o castelo levanta voo em poucos minutos — a mesa precisa sair correndo para as correntes ou para a carga, não vencer o refúgio. Se apanharem, os PJs são amarrados e levados como prisioneiros PARA o castelo (o Ep8 começa numa cela — gancho perfeito, não um game over). Não encerre a campanha aqui.',
        encontro: [{ nome: 'Cultista', qtd: 5 }, { nome: 'Garra do Dragão (Dragonclaw)', qtd: 2 }, { nome: 'Guarda Draco (Guard Drake)', qtd: 2 }],
        saidas: [
          { para: 'e7_final_correntes', rotulo: 'Correr para as correntes antes que subam', aviso: '' },
          { para: 'e7_final_carga', rotulo: 'Mergulhar na última rede de carga', aviso: '' },
        ],
      },
      {
        id: 'e7_final_carga', titulo: 'A bordo, dentro de uma arca', tipo: 'final', resultado: 'vitoria',
        narracao: 'A rede se fecha, o chão some e o mundo balança. Encolhidos entre o saque de Greenest, vocês sobem pelo ar frio até um estalo surdo de pedra: a carga chegou. Do lado de fora da arca, ecoando na barriga de uma fortaleza que voa, vozes conferem os róis. Ninguém conta o que veio dentro. — Fim do Episódio 7.',
        notasMestre: 'Vitória "clandestina": chegam ao castelo voador escondidos na carga, no depósito, sem ninguém saber. No Ep8 começam dentro, invisíveis mas encurralados. XP: caminho para o nível 7. Pistas: onde Rezmir dorme, a Máscara Negra, e (se falaram com Talis/Yarra) o dragão acorrentado. PRÓXIMO: importar "Ep. 8 — Castelo nas Nuvens".',
        encontro: [], saidas: [],
      },
      {
        id: 'e7_final_correntes', titulo: 'Pela corrente, sobre o abismo', tipo: 'final', resultado: 'vitoria',
        narracao: 'Metro a metro, com as mãos em carne viva e o vale encolhendo lá embaixo, vocês sobem a corrente até a pedra gelada da fundação. Ninguém sobe por aqui — é exatamente por isso que funciona. Quando o castelo estremece e começa a se mover, vocês já estão do lado de dentro, agarrados à barriga de uma montanha voadora. — Fim do Episódio 7.',
        notasMestre: 'Vitória "pela força": subiram sem dever nada a ninguém (e sem a informação de Talis). No Ep8 entram por baixo, pela fundação — longe do tesouro e dos aposentos, mas também longe da guarda. XP: nível 7. Se Talis foi derrotada/afugentada, o culto no castelo ainda NÃO sabe que vocês vêm. PRÓXIMO: importar "Ep. 8 — Castelo nas Nuvens".',
        encontro: [], saidas: [],
      },
      {
        id: 'e7_final_talis', titulo: 'O acordo com a Branca', tipo: 'final', resultado: 'vitoria',
        narracao: 'Talis se levanta enfim, e pela primeira vez sorri de verdade — um sorriso sem nenhuma bondade dentro. "Subam com a próxima carga. Ninguém vai revistar." Ela abre a porta e recita, de memória, a planta do castelo, o horário da guarda e onde a Rezmir dorme. Na soleira, acrescenta como quem comenta o tempo: "Ah — cuidado com o que dorme no coração da pedra. Ele está com fome há muito tempo." — Fim do Episódio 7.',
        notasMestre: 'Vitória "política" — a melhor rota. Talis dá passagem segura, a planta, a rotina da guarda, o quarto de Rezmir E o aviso sobre Glazhael (o dragão branco acorrentado). No Ep8, conceda isso mecanicamente: vantagem em Furtividade nas primeiras cenas e o mapa do castelo. Lembre a mesa: Talis NÃO é aliada — quer Rezmir morta e o crédito para si; vai cobrar isso um dia. XP: nível 7. PRÓXIMO: importar "Ep. 8 — Castelo nas Nuvens".',
        encontro: [], saidas: [],
      },
      {
        id: 'e7_partir', titulo: 'A sombra que se foi', tipo: 'final', resultado: 'neutro',
        narracao: 'Vocês assistem da encosta: as correntes se recolhem, a montanha impossível gira devagar e se afasta sobre o vale, levando dentro dela o saque de meia dúzia de vilas e a mulher de escamas negras. Em pouco tempo é só um ponto no céu de inverno. Depois, nem isso.',
        notasMestre: 'Beco intencional: o castelo parte sem eles. Não é o fim — o culto precisa de mais tesouro, e há outros pontos de coleta; a campanha pode retomar por outra rota (ou pelo hub). Mas mostre o custo: o tesouro chegou ao destino, e a Rainha está mais perto de acordar.',
        encontro: [], saidas: [],
      },
    ],
  },
