...
|---|---|---|---|
| 🔴 1 | **Fase 23 — MONETIZAÇÃO POR CRÉDITOS** (campanha = R$5/mês = 20 créditos, inclui 6 fichas de PJ + controle total de Mestre; jogador grátis; crédito R$0,25, mín. R$2; Pix manual→automático; painel admin) — modelo e sub-fases em `docs/MONETIZACAO.md`. **✅ 23.1 carteira + ✅ 23.2/23.8 comprar créditos com Pix AbacatePay** (14/07) **+ ✅ 23.3 campanha=produto + ✅ 23.4 limite 6 fichas** (15/07: criar/renovar debita 20 créditos + `pagaAte`; campanha sem pagamento em dia vira só-leitura; servidor rejeita a 7ª ficha de PJ); faltam 23.5 jobs mensais/retenção · 23.6 admin completo · 23.7 migração jogador-grátis | **Pedido direto do Ismaile (14/07)**: cobrar novos membros pagantes; é a receita do produto | G (M por sub-fase) |
