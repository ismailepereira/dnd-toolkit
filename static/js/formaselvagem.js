...
function formaSelvagemDados(nome) {
  return FORMAS_SELVAGENS.find(f => f.nome === nome) || null;
}
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { FORMAS_SELVAGENS, limiteFormaSelvagem, formasSelvagensDisponiveis, formaSelvagemDados, ndRotulo };
}
