...
14. 🟡 **Fase 14** — Grid Virtual / mapa de combate — **14.1 + 14.2 + 14.3 entregues 08/07/2026** (matemática pura `grid.js`; grid SVG com tokens clicáveis na aba Combate; e a **ajuda tática do jogador agora detecta adjacência real pelo mapa** — inimigo adjacente / aliado adjacente ao alvo viram "auto", com fallback aos toggles manuais sem mapa). Faltam 14.4 (obstáculos/cobertura), 14.5 (áreas de efeito), 14.6 (imagem de fundo)
