...
| 🟠 3 | **Fase 19 — CAMPANHA PHANDELVER COMPLETA** (✅ PH0 bestiário/itens · ✅ PH1 Phandalin · ✅ PH2 Marcarrubra [15/07] → **faltam PH3 Teia da Aranha → PH4 Castelo Dentefino → PH5 Caverna Onda Eco → PH6 finais/integração**) — plano nó a nó em `docs/CAMPANHA-PHANDELVER.md`; 1 sub-fase (PHx) por run, meia sub-fase coesa se não couber | **Pedido do Ismaile (14/07 + 15/07)**: campanha completa capítulo a capítulo; ele notou que a importável estava "pouco trabalhada" — porque dava beco na porta do 1º calabouço. PH2 retomou a metade de masmorra | G (M por capítulo) |
