...
**Progresso:**
- [x] 23.1 (14/07) · [x] 23.2+23.8 AbacatePay (14/07) · [x] 23.3 campanha=produto (15/07) · [x] 23.4 limite 6 fichas (15/07) · [x] 23.5 jobs/retenção lazy (15/07) · [x] 23.6 painel admin completo (15/07) · [x] 23.9 dashboard admin c/ gráficos (15/07) · [x] 23.7 bônus de boas-vindas + migração jogador-grátis (15/07)

**✅ FASE 23 CONCLUÍDA (15/07/2026).** Cobrança 100% por créditos/campanha. A assinatura plana da Fase 10.9 está **desligada** por padrão (`EXIGIR_ASSINATURA_PLANA=0`); ligar `=1` faz rollback. O bloqueio manual do admin (`bloqueado`) continua valendo sempre.
