...
| 🟠 3 | **Fase 19 — CAMPANHA PHANDELVER COMPLETA** (PH0 bestiário/itens → PH1 Phandalin → PH2 Marcarrubra → PH3 Teia da Aranha → PH4 Castelo Dentefino → PH5 Caverna Onda Eco → PH6 finais/integração) — plano nó a nó em `docs/CAMPANHA-PHANDELVER.md`; 1 sub-fase (PHx) por run, meia sub-fase coesa se não couber | **Pedido direto do Ismaile (14/07)**: campanha completa capítulo a capítulo, sem deixar nada pra trás; Cap. 1 já entregue serve de padrão | G (M por capítulo) |
